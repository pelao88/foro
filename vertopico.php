...
<body>
	<div class="pane">
		...
		<?php 
			disptopico($_GET['cid'],$_GET['scid'],$_GET['tid']);
			echo "<div class='content'><p>Todas las respuestas ()";/*thjis woll display the bnumer of replies*/
			echo "</p></div>";
			//this will display all replies to rhe specific topic	
		?>
	</div>
</body>
</html>